          ...
          <div className="lg:w-[420px] pt-[40px] w-[325px] flex-none bg-green-300">
            ...
            <div className="flex justify-between px-0.5 items-center h-[52px] py-[10px]">
              ...
              <div className="flex border rounded-lg divide-x">
                <span className="text-sm font-medium py-[8px] px-[10px] flex-none">
                  RU SIZES
                </span>
                <span className="text-sm font-medium py-[8px] px-[10px] flex-none">
                  RU SIZES
            ...
            <div className="max-w-full">
              <div className="flex flex-wrap">
                {/* кнопка map */}
                {product.map((item) => (
                  <div className="w-1/5 max-w-full p-0.5">
                    <div className="w-full border cursor-pointer rounded-lg h-[55px] flex items-center justify-center">
                      {item.id}
                    </div>
                  </div>
                ))}
